...
si="C:/Users/asus/Downloads/snakegif.gif"
si2="C:/Users/asus/Downloads/snakegif2.gif"
t.register_shape(si)
...
playsound("C:/Users/asus/Downloads/videoplayback.mp3",False )
...
def gameOver():
    playsound("C:/Users/asus/Downloads/smb_mariodie.wav",False)
    t.bgcolor("yellow")
    snake.color("yellow")
    apple.color("yellow")
    t.penup()
...
def startGame():
    ...
    while True:
        ...
        if snake.distance(apple)<27:
            playsound("C:/Users/asus/Downloads/button-3.wav",False )
            placeApple()
            snake_length+=1
            snake.shapesize(0.5,snake_length,0.5)
            snake_speed+=0.4
